...
class ZmanimCalendar extends AstronomicalCalendar_1.AstronomicalCalendar {
    ...
    */
    ...
    isAssurBemlacha(currentTime, tzais, inIsrael) {
        ...
        if (jewishCalendar.hasCandleLighting() && Utils_1.DateUtils.compareTo(currentTime, this.getElevationAdjustedSunset()) >= 0) {
            return true;
        }
        // is shabbos or YT and it is before tzais
        return jewishCalendar.isAssurBemelacha() && Utils_1.DateUtils.compareTo(currentTime, tzais) <= 0;
    }
}
